    ...
    loop {
        ...
        match comm.next_event() {
            ...
            io::Event::Command(0x03) => {
                ...
                let description = ArrayString::<64>::from_bytes(
                    comm.get(5 + 32, 5 + 32 + 64));
                let pass = match comm.get(2, 3)[0] {
                    0 => Some(ArrayString::<32>::from_bytes(
                        comm.get(5 + 32 + 64, 5 + 32 + 64 + 32),
                    )),
                    _ => None,
                };
                comm.reply(
                    match set_password(passwords, &name, &description, &pass) {
                        Ok(()) => StatusWords::OK,
            ...
            io::Event::Command(0x04) => {
                ...
                match passwords.get(index as usize) {
                    Some(password) => {
                        ...
                        comm.append(password.description.bytes());
                        comm.reply_ok()
                    }
