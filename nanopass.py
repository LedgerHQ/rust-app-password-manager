...
class Client:
    ...
    def add(self, name: str, description: str, password: Optional[str] = None):
        """
        Add a new password.
        ...
        desc_bytes = str_to_bytes_pad(description, MAX_DESCRIPTION_LEN)
        ...
        self.dev.apdu_exchange(0x03, p1=p1, data=name_bytes + desc_bytes + password_bytes)

    def get_entry(self, index: int) -> str:
        """
        Retrieve name and description of a password
        :param index: Password entry index
        :return: Name
        """
        r = self.dev.apdu_exchange(0x04, index.to_bytes(4, 'big'))
        return (bytes_to_str(r[:32]), bytes_to_str(r[32:32+64]))

    def get_entries(self) -> List[str]:
        """ :return: List of password names """
        return [self.get_entry(i) for i in range(self.get_size())]
